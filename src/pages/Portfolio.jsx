...
export default function Portfolio() {
    ...
    return (
        <main className={`${BG} text-white min-h-screen font-sans overflow-hidden`}>
                ...
                <div className="container mx-auto px-4 pt-10 pb-20 lg:pt-20 lg:pb-28">
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                            <p className="text-blue-400/80 text-sm tracking-widest uppercase">QC Engineer | Manual & Automation Tester</p>
                            <h1 className="mt-2 text-4xl lg:text-5xl font-bold leading-tight">
                                Hi, I’m <span className="text-blue-500">Nguyễn Viết Trường</span>
                            </h1>
            ...
            {/* Skills – 100% MATCH CV nhưng GỌN HƠN, CHUYÊN NGHIỆP HƠN */}
            ...
            {/* Projects – giữ nguyên nội dung CV */}
            ...
            {/* Gallery, Contact, Footer – giữ nguyên đẹp */}
            ...
            <section id="contact" className="container mx-auto px-4 py-12 lg:py-20 border-t border-white/10">
                <motion.h2 className="text-3xl font-bold mb-6" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>Get In Touch</motion.h2>
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-5 text-white/70 text-lg">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>Phone: <a href="tel:+84399890382" className="text-blue-500 hover:underline">+84 399 890 382</a></li>
                    ...
                    <motion.form className={`rounded-2xl p-5 ${CARD} grid gap-4`}>
                        <input className="w-full rounded-xl bg-transparent border border-white/10 px-4 py-3 focus:border-blue-500 outline-none transition" placeholder="Your name" />
                        <input type="email" className="w-full rounded-xl bg-transparent border border-white/10 px-4 py-3 focus:border-blue-500 outline-none transition" placeholder="Your email" />
                        <textarea rows={4} className="w-full rounded-xl bg-transparent border border-white/10 px-4 py-3 focus:border-blue-500 outline-none transition resize-none" placeholder="Message..." />
            ...
            <motion.footer className="border-t border-white/10 py-8 text-center text-white/60 text-sm">
                © 2025 Nguyễn Viết Trường — QC Engineer. Built with Tailwind + Framer Motion
            </motion.footer>
        </main>
    )
}
